...
=======
//unsigned long interval_showmode = 4000;
unsigned long interval_showmode = 4000;
>>>>>>> 8da9cc4cbb21c53f3656656af82162841c408961
...
=======
//unsigned long interval_dht_detect = 4000;
unsigned long interval_dht_detect = interval_showmode*4;
>>>>>>> 8da9cc4cbb21c53f3656656af82162841c408961
...
=======
  if (((currentMillis_showmode - previousMillis_showmode) >= interval_showmode) and ((currentMillis_showmode - previousMillis_showmode) < interval_showmode*4)) {
    showmode = 1;
  }
  if ((currentMillis_showmode - previousMillis_showmode) >= interval_showmode*4) {
>>>>>>> 8da9cc4cbb21c53f3656656af82162841c408961
