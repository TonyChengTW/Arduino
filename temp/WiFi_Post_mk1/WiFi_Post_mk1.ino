...
const char *SSID     = "Tony_WiFi";
const char *PASSWORD = "8860225231449";
#define HOST_NAME   "www.strongniche.com.tw"
#define HOST_PORT   (80)

SoftwareSerial mySerial(12, 13); //SoftwareSerial pins for MEGA/Uno. For other boards see: https://www.arduino.cc/en/Reference/SoftwareSerial
...
{   
    wifi.httpGet();
    Serial.println("Entering to loop");
